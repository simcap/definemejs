defineme.js (inspired by [hijs](https://github.com/cloudhead/hijs)) is a simple script that add links to external service for words definitions to your text content.
